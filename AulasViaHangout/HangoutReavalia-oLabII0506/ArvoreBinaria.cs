...
namespace Hangout0506
{
    class ArvoreBinaria
    {
        ...
        private int altura(Aluno raizArvore)
        {
            if (raizArvore == null)
            {
                return -1;
            ...
            {
                int altesq = altura(raizArvore.esquerda);
                int altdir = altura(raizArvore.direita);
                
                /* Para retornar o numero de filhos.
                return ((altesq+1) + (altdir+1));
                */

                //Para retornar a altura da arvore.
                if (altesq < altdir)
                {
                    return (altdir+1);
                }
